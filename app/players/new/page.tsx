...
export default function NewPlayerPage() {
  ...
  // Auth check - only Super Admin can create players
  ...
  // Only Super Admin is allowed - this will redirect due to useAuth('SUPER_ADMIN')
  // but show access denied if they somehow get here without being super admin
  if (!isSuperAdmin) {
    return (
      <ResponsiveLayout>
